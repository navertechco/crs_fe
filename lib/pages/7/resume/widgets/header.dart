        ...
        Row(
          children: [
            ...
            CustomDetailWidget(
                label: "dni: ",
                value:
                    getFormValue(globalctx["memory"], "customer", "dni", '')),
          ],
        ),
        Row(
          children: [
            ...
            CustomDetailWidget(
                label: "City: ",
                value:
                    getFormValue(globalctx["memory"], "customer", "city", '')),
            CustomDetailWidget(
                label: "Country: ",
                value: getFormValue(
                    globalctx["memory"], "customer", "country", '')),
          ],
        ),
        ...
        Row(
          children: [
            ...
            CustomDetailWidget(
                label: "Country: ",
                value:
                    getFormValue(globalctx["memory"], "tour", "country", '')),
          ],
        ),
