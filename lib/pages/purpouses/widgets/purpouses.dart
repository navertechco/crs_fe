...
class PurpousesWidget extends StatefulWidget {
  const PurpousesWidget({Key? key, required this.title}) : super(key: key);

  final String title;

  @override
  _PurpousesWidgetState createState() => _PurpousesWidgetState();
}

class _PurpousesWidgetState extends State<PurpousesWidget> {
